...
export function OrganizationStructuredData({ locale }: { locale: string }) {
  ...
  const structuredData = {
    ...
    "sameAs": [
      "https://twitter.com/vooksio",
      "https://linkedin.com/company/vooksio",
      "https://github.com/vooksio"
    ],
    "address": {
      "@type": "PostalAddress",
      "addressCountry": "EG"
  ...
  const services = {
    'software-engineering': {
      en: {
        ...
        description: "Professional software development, architecture design, and technical consulting for scalable applications",
