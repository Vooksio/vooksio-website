        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div className="inline-flex items-center px-4 py-2 bg-white/60 rounded-full vooksio-border-gradient backdrop-blur-sm">
              ...
              <span className="text-[#1E2A38] text-sm font-medium">{t("badge")}</span>
            </div>

            <div className="space-y-4">
              <h1 className="text-4xl lg:text-6xl font-bold text-[#1E2A38] leading-tight">
                {t("headline")}
                <span className="block vooksio-text-gradient">{t("headlineAccent")}</span>
              </h1>
              <p className="text-xl text-[#6B7280] leading-relaxed max-w-xl">{t("description")}</p>
            </div>

            <div className="flex flex-wrap gap-6">
              <div className="flex items-center">
                <Code className="w-5 h-5 mr-2" style={{ color: "var(--vooksio-purple)" }} />
                <span className="text-[#1E2A38]">{t("point1")}</span>
              </div>
              <div className="flex items-center">
                <Users className="w-5 h-5 mr-2" style={{ color: "var(--vooksio-cyan)" }} />
                <span className="text-[#1E2A38]">{t("point2")}</span>
              </div>
              <div className="flex items-center">
                <Zap className="w-5 h-5 mr-2" style={{ color: "var(--vooksio-orange)" }} />
                <span className="text-[#1E2A38]">{t("point3")}</span>
              </div>
            </div>
            ...
            {/* <div className="pt-8 border-t border-[#E5E7EB]">
              <p className="text-sm text-[#6B7280] mb-4">{t("socialProof")}</p>
              <div className="flex items-center space-x-6">
                <div className="text-center">
                  <div className="text-2xl font-bold text-[#1E2A38]">50+</div>
                  <div className="text-sm text-[#6B7280]">{t("appsBuilt")}</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-[#1E2A38]">200+</div>
                  <div className="text-sm text-[#6B7280]">{t("devsMentored")}</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-[#1E2A38]">98%</div>
                  <div className="text-sm text-[#6B7280]">{t("successRate")}</div>
                </div>
              </div>
            </div> */}
          </div>
          ...
          <div className="relative">
            <div className="relative z-10 vooksio-card rounded-2xl vooksio-shadow p-8">
              <div className="bg-[#1E2A38] rounded-lg p-4 font-mono text-sm">
                <div className="flex items-center mb-3">
                  ...
                  <span className="text-[#6B7280] ml-4">app.tsx</span>
                </div>
                <div style={{ color: "var(--vooksio-emerald)" }}>
                  <span style={{ color: "var(--vooksio-pink)" }}>function</span>{" "}
                  <span className="text-white">BuildAmazingApp</span> <span className="text-[#6B7280]">() {`{`}</span>
                </div>
                ...
                <div className="text-[#6B7280] ml-8">
              ...
              <div className="mt-6 space-y-3">
                ...
                >
                  <span className="text-[#1E2A38]">{t("buildStatus")}</span>
                ...
                >
                  <span className="text-[#1E2A38]">{t("deployment")}</span>
