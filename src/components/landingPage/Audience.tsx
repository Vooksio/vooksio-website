  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                <CardHeader className="pb-4">
                  <div className="flex items-center justify-between mb-4">
                    {audience.icon}
                    <ArrowRight
                      className={cn("w-5 h-5 text-muted-gray opacity-0 group-hover:opacity-100 transition-opacity", {
                ...
                <CardContent className="flex flex-col justify-between flex-1">
                  <div className="space-y-4 mb-6">
                    <p className="text-muted-gray leading-relaxed break-words whitespace-normal">
        ...
        {/* CTA Section */}
        <div className="mt-20 bg-gradient-to-r from-dark-navy to-primary-blue rounded-2xl p-8 lg:p-12 text-center relative">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <ServerActionLink
              href={`/${locale}/contact-us`}
              className="bg-white text-foreground hover:bg-input-bg px-8 py-4"
              variant="outline"
            >
              {t("cta.primary")}
